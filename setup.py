...
Multi-platform hardware-accelerated AI inference runtime
"""
...
HAS_INTEL_GPU = os.path.exists("/dev/dri/renderD128")
...
setup(
    ...
    description="Multi-platform hardware-accelerated AI execution framework",
