#!/usr/bin/env python3
"""
Complete fix for GPU loading - ensures actual tensor data loads to GPU
"""
...
'''
    ...
    with open('real_gpu_pipeline.py', 'w') as f:
        f.write(fixed_code)
    
    print("✅ Created real_gpu_pipeline.py")
    print("\nThis version:")
    print("- Loads safetensors files directly")
    print("- Actually transfers tensor data to GPU")
    print("- Skips vision components")
    print("- Should achieve ~16GB VRAM usage")
